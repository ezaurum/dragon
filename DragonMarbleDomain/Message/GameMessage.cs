...
public class RollMoveDiceResultGameMessage : IDragonMarbleGameMessage	
{
	...
	public byte[] ToByteArray()
	{
		...
		.CopyTo(bytes,index);
		index += sizeof(Char);
		BitConverter.GetBytes(DoubleCount)
		.CopyTo(bytes,index);
		index += sizeof(Char);
	return bytes;
}
...
public void FromByteArray(byte[] bytes)
{
		...
		Dices.Add(BitConverter.ToChar(bytes, index));
		index += sizeof(Char);
		DoubleCount = BitConverter.ToChar(bytes, index);
		index += sizeof(Char);
}
	...
	public Int16 Length
	{
		get
		{
			return (Int16)(2+sizeof(GameMessageType)+16+16+16+2*(sizeof(Char))+sizeof(Char));
		}
	}
}
...
public void FromByteArray(byte[] bytes)
{
	...
	public Int16 Length
	{
		get
		{
			return (Int16)(2+sizeof(GameMessageType)+16+16+16+sizeof(Int16)+16);
		}
	}
}
...
public void FromByteArray(byte[] bytes)
{
	...
	public Int16 Length
	{
		get
		{
			return (Int16)(2+sizeof(GameMessageType)+16+16+16+sizeof(Int16)+sizeof(Int16)+NumberOfPlayers*(sizeof(Boolean)));
		}
	}
}
...
public void FromByteArray(byte[] bytes)
{
	...
	public Int16 Length
	{
		get
		{
			return (Int16)(2+sizeof(GameMessageType)+16+16+16+16+sizeof(Int64));
		}
	}
}
...
public void FromByteArray(byte[] bytes)
{
	...
	public Int16 Length
	{
		get
		{
			return (Int16)(2+sizeof(GameMessageType)+16+16+16+sizeof(Single)+sizeof(Boolean)+sizeof(Boolean));
		}
	}
}
...
public void FromByteArray(byte[] bytes)
{
	...
	public Int16 Length
	{
		get
		{
			return (Int16)(2+sizeof(GameMessageType)+16+16+16+4*(sizeof(Int16))+sizeof(Int16)+NumberOfPlayers*(sizeof(Int32)+sizeof(Int32)+sizeof(StageUnitInfo.UNIT_COLOR)+sizeof(StageUnitInfo.TEAM_GROUP)+sizeof(StageUnitInfo.ControlModeType)+16));
		}
	}
}
